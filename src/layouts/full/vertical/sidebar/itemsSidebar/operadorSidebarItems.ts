    ...
    children: [
      {
        ...
        id: uniqueId(),
        children: [
          { id: uniqueId(), name: 'Registrar venta', icon: 'solar:cart-plus-linear', url: '/operador/caja-facturacion' },
          { id: uniqueId(), name: 'Registrar gasto', icon: 'solar:arrow-down-linear', url: '/operador/caja-facturacion' },
